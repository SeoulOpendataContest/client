            ...
            itemBuilder: (BuildContext context, int index) {
              return ElevatedButton(
                ...
                child: Column(
                  children: [
                    Image.asset(
                      'asset/store/가맹점-${storeFilter[index]}.png',
                      width: 80,
                      height: 80,
                    ),
                    const SizedBox(
                  ...
                  Row(
                    children: [
                      ...
                      currentFilter == 0
                          ? const SizedBox()
                          : Image.asset(
                              'asset/store/가맹점-${storeFilter[currentFilter]}.png',
                              width: 30,
                              height: 30,
                            ),
                      const SizedBox(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        //image
                                        storeInfo[index].category == "일반대중음식"
                                            ? Image.asset(
                                                'asset/categorylist/기타 리스트.png',
                                                height: 20,
                                              )
                                            : Image.asset(
                                                'asset/categorylist/${storeInfo[index].category} 리스트.png',
                                                height: 20,
                                              ),
                                        const SizedBox(
                                          height: 8,
